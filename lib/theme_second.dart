...
class Theme2Widget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    // Figma Flutter Generator Theme2Widget - FRAME
    return Container(
      width: 375,
      height: 812,
      ...
      child: Stack(
        ...
        top: 77,
        left: 14,
        child: Text('# 데이트', textAlign: TextAlign.center, style: TextStyle(
        ...
        top: 243,
        left: 47,
        child: Text('케이블카는 못 참제', textAlign: TextAlign.left, style: TextStyle(
            color: Color.fromRGBO(255, 255, 255, 1),
            fontFamily: 'Noto Sans',
            fontSize: 16,
            letterSpacing: -0.23999999463558197,
        ...
        top: 371,
        left: 49,
        child: Text('목포 여서 사진찍으믄 잘 나온디', textAlign: TextAlign.left, style: TextStyle(
            color: Color.fromRGBO(255, 255, 255, 1),
        fontFamily: 'Noto Sans',
        fontSize: 16,
        letterSpacing: -0.23999999463558197,
    ...
    top: 543,
    left: 41,
    child: Text('여수는 모다? 밤바다다 ', textAlign: TextAlign.center, style: TextStyle(
    color: Color.fromRGBO(255, 255, 255, 1),
    fontFamily: 'Noto Sans',
    fontSize: 16,
    letterSpacing: -0.23999999463558197,
    ...
    top: 662,
    left: 48,
    child: Text('전주 왔는데 비빔밥 안 묵는다고야', textAlign: TextAlign.left, style: TextStyle(
    color: Color.fromRGBO(255, 255, 255, 1),
    fontFamily: 'Noto Sans',
    fontSize: 16,
    letterSpacing: -0.23999999463558197,
