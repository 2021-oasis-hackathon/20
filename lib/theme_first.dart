...
class Theme1Widget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    // Figma Flutter Generator Theme1Widget - FRAME
    return Container(
      width: 375,
      height: 812,
      ...
      child: Stack(
        ...
        top: 77,
        left: 55,
        child: Text('# 자연 속에서 힐링하기 ', textAlign: TextAlign.center, style: TextStyle(
        ...
        top: 242,
        left: 41,
        child: Text('아따 소쇄원에서 신선놀음', textAlign: TextAlign.center, style: TextStyle(
            color: Color.fromRGBO(255, 255, 255, 1),
            fontFamily: 'Noto Sans',
            fontSize: 16,
            letterSpacing: -0.23999999463558197,
        ...
        top: 372,
        left: 49,
        child: Text('청산도 여가뷰 맛집이당께', textAlign: TextAlign.left, style: TextStyle(
            color: Color.fromRGBO(255, 255, 255, 1),
        fontFamily: 'Noto Sans',
        fontSize: 16,
        letterSpacing: -0.23999999463558197,
    ...
    top: 515,
    left: 49,
    child: Text('피톤치드 마셔블기  ', textAlign: TextAlign.left, style: TextStyle(
    color: Color.fromRGBO(255, 255, 255, 1),
    fontFamily: 'Noto Sans',
    fontSize: 16,
    letterSpacing: -0.23999999463558197,
    ...
    top: 644,
    left: 49,
    child: Text('순천만이 그러게 이쁘다는디 ', textAlign: TextAlign.left, style: TextStyle(
    color: Color.fromRGBO(255, 255, 255, 1),
    fontFamily: 'Noto Sans',
    fontSize: 16,
    letterSpacing: -0.23999999463558197,
