        ...
        child: Stack(
            children: <Widget>[
              ...
              Positioned(
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: AssetImage(
                                'assets/images/Rectangle2650.png'),
                            fit: BoxFit.fitWidth
                        ),
                      )
                  )
              ...
              Positioned(
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: AssetImage(
                                'assets/images/Rectangle2651.png'),
                            fit: BoxFit.fitWidth
                        ),
                      )
                  )
              ...
              Positioned(
                  top: 289,
                  left: -38,
                  child: Text('가장 인기 많은 쉼터', textAlign: TextAlign.center,
                    style: TextStyle(
              ...
              Positioned(
                  ...
                  left: -62,
                  child: Text(
                    '새로운 업로드', textAlign: TextAlign.center, style: TextStyle(
                      color: Color.fromRGBO(0, 0, 0, 1),
                      fontFamily: 'Noto Sans',
                      fontSize: 17,
                      letterSpacing: -0.23999999463558197,
              ...
              Positioned(
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: AssetImage(
                                'assets/images/Rectangle2649.png'),
                            fit: BoxFit.fitWidth
                        ),
                      )
                  )
                      ...
                      child: Stack(
                          children: <Widget>[
                            Positioned(
                                ...
                                top: 28,
                                left: 0,
                                child: Text('검색', textAlign: TextAlign.center,
                                  style: TextStyle(
                      ...
                      child: Stack(
                          children: <Widget>[
                            Positioned(
                                ...
                                top: 28,
                                left: 83,
                                child: Text('트렌드', textAlign: TextAlign.center,
                                  style: TextStyle(
                                      color: Color.fromRGBO(143, 143, 143, 1),
                                      fontFamily: 'Noto Sans',
                                      fontSize: 15,
