        ...
        child: Stack(
            children: <Widget>[
              Positioned(
                  ...
                  top: 289,
                  left: -38,
                  child: Text('가장 인기 많은 쉼터', textAlign: TextAlign.center, style: TextStyle(
                  ...
                  top: 526,
                  left: -62,
                  child: Text('새로운 업로드', textAlign: TextAlign.center, style: TextStyle(
                      color: Color.fromRGBO(0, 0, 0, 1),
                      fontFamily: 'Noto Sans',
                      fontSize: 17,
                      letterSpacing: -0.23999999463558197,
                                          ...
                                          Positioned(
                                              ...
                                              child: Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    ...
                                                    gradient : LinearGradient(
                                                        begin: Alignment(1.0252857370480475e-16,1.674418568611145),
                                                        end: Alignment(-1.674418568611145,7.573026813935055e-15),
                                                        colors: [Color.fromRGBO(255, 255, 255, 1),Color.fromRGBO(231, 231, 231, 1)]
                                                    ),
                                                    borderRadius : BorderRadius.all(Radius.elliptical(34.27734375, 33.75)),
                                                  )
                                              )
                                          ),Positioned(
                                              top: 2.8125,
                                              ...
                                              child: Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    gradient : LinearGradient(
                                                        ...
                                                        colors: [Color.fromRGBO(235, 235, 235, 1),Color.fromRGBO(255, 255, 255, 1)]
                                                    ),
                                                    borderRadius : BorderRadius.all(Radius.elliptical(28.564453125, 28.125)),
                                                  )
                                              )
                                          ),Positioned(
                                              top: 2.8125,
                                              ...
                                              child: Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    gradient : LinearGradient(
                                                        ...
                                                        colors: [Color.fromRGBO(65, 217, 250, 1),Color.fromRGBO(30, 182, 215, 1)]
                                                    ),
                                                    borderRadius : BorderRadius.all(Radius.elliptical(28.564453125, 28.125)),
                                                  )
                                              )
                                              ...
                                              child: Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    ...
                                                    borderRadius : BorderRadius.all(Radius.elliptical(26.660152435302734, 26.25000762939453)),
                                                  )
                                              )
                                          ),
                                        ]
