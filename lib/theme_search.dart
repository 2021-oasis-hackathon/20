  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Stack(
        ...
        top: 516,
        left: 53,
        child: Text('후레쉬하게 회 한 점할라는디 같이 먹게잉', textAlign: TextAlign.left, style: TextStyle(
            color: Color.fromRGBO(255, 255, 255, 1),
        fontFamily: 'Noto Sans',
        fontSize: 18,
        letterSpacing: -0.23999999463558197,
    ...
    image : DecorationImage(
    image: AssetImage('assets/images/Rectangle2664.png'),
    fit: BoxFit.fitWidth
    ),
    )
    )
    ...
    image : DecorationImage(
    image: AssetImage('assets/images/Rectangle2665.png'),
    fit: BoxFit.fitWidth
    ),
    )
    )
    ...
    top: 249,
    left: 49,
    child: Text('여수 뷰 좋은 카페', textAlign: TextAlign.left, style: TextStyle(
    color: Color.fromRGBO(255, 255, 255, 1),
    fontFamily: 'Noto Sans',
    fontSize: 18,
    letterSpacing: -0.23999999463558197,
    ...
    top: 137,
    left: 73,
    child: Text('# 자연 속에서 힐링하기', textAlign: TextAlign.left, style: TextStyle(
    color: Color.fromRGBO(125, 125, 125, 1),
    fontFamily: 'Noto Sans',
    fontSize: 18,
    letterSpacing: -0.23999999463558197,
    ...
    top: 177,
    left: 73,
    child: Text('# 데이트', textAlign: TextAlign.left, style: TextStyle(
    color: Color.fromRGBO(125, 125, 125, 1),
    fontFamily: 'Noto Sans',
    fontSize: 18,
    letterSpacing: -0.23999999463558197,
    ...
    top: 220,
    left: 73,
    child: Text('# 인생샷', textAlign: TextAlign.left, style: TextStyle(
    color: Color.fromRGBO(125, 125, 125, 1),
    fontFamily: 'Noto Sans',
    fontSize: 18,
    letterSpacing: -0.23999999463558197,
    ...
    top: 263,
    left: 73,
    child: Text('# 문화예술', textAlign: TextAlign.left, style: TextStyle(
    color: Color.fromRGBO(125, 125, 125, 1),
    fontFamily: 'Noto Sans',
    fontSize: 18,
    letterSpacing: -0.23999999463558197,
    ...
    top: 306,
    left: 73,
    child: Text('# 드라이브 코스', textAlign: TextAlign.left, style: TextStyle(
    color: Color.fromRGBO(125, 125, 125, 1),
    fontFamily: 'Noto Sans',
    fontSize: 18,
    letterSpacing: -0.23999999463558197,
    ...
    top: 349,
    left: 73,
    child: Text('# 가족과 함께', textAlign: TextAlign.left, style: TextStyle(
    color: Color.fromRGBO(125, 125, 125, 1),
    fontFamily: 'Noto Sans',
    fontSize: 18,
    letterSpacing: -0.23999999463558197,
    ...
    top: 373,
    left: 49,
    child: Text('음식은 전라도제 ', textAlign: TextAlign.left, style: TextStyle(
    color: Color.fromRGBO(255, 255, 255, 1),
    fontFamily: 'Noto Sans',
    fontSize: 16,
    letterSpacing: -0.23999999463558197,
