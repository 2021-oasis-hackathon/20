        ...
        child: Stack(
            children: <Widget>[
              ...
              Positioned(
                  ...
                  left: 14,
                  child: Text(
                    '# 인생샷', textAlign: TextAlign.center, style: TextStyle(
              ...
              Positioned(
                  top: 225,
                  left: 49,
                  child: Text('돗자리 착 펴놓고 놀믄 여가 천국이여', textAlign: TextAlign.left,
                    style: TextStyle(
                        color: Color.fromRGBO(255, 255, 255, 1),
                        fontFamily: 'Noto Sans',
                        fontSize: 16,
              ...
              Positioned(
                  top: 390,
                  left: 48,
                  child: Text('바다랑 철길 안 보고 갈껴?', textAlign: TextAlign.left,
                    style: TextStyle(
                        color: Color.fromRGBO(255, 255, 255, 1),
                        fontFamily: 'Noto Sans',
                        fontSize: 16,
              ...
              Positioned(
                  ...
                  left: 48,
                  child: Text(
                    '숨 깔딱깔딱 넘어가는디 풍경은 기가 막혀부러 ', textAlign: TextAlign.left,
                    style: TextStyle(
                        color: Color.fromRGBO(255, 255, 255, 1),
                        fontFamily: 'Noto Sans',
                        fontSize: 16,
              ...
              Positioned(
                  top: 661,
                  left: 48,
                  child: Text('여까지 왔는디 사진 한 장 건져가쇼잉', textAlign: TextAlign.left,
                    style: TextStyle(
                        color: Color.fromRGBO(255, 255, 255, 1),
                        fontFamily: 'Noto Sans',
                        fontSize: 16,
